...
public class Test_ProtoIntegration
{
    ...
    public void CalcJoyIntesnity()
    {
        ...
        EmIntensityT joyIntensity = new EmIntensityT(1.0d); 
    ...
    public void GenerateJoy()
    {
        ...
        ProtoDistanceChangeCausedByEvent epsilonJ = new ProtoDistanceChangeCausedByEvent(event1); 
        ...
        (WorldStateViewT<AgentSimItemSlot>.DistBtwWorldStateViewsT distPrev, 
            ...
            WorldStateViewT<AgentSimItemSlot>.DistChgBtwWorldStateViewsT distDelta)? joy1;
        (WorldStateViewT<AgentSimItemSlot>.DistBtwWorldStateViewsT distPrev, 
            WorldStateViewT<AgentSimItemSlot>.DistBtwWorldStateViewsT distNow, 
            WorldStateViewT<AgentSimItemSlot>.DistChgBtwWorldStateViewsT distDelta)? joy2;
        (WorldStateViewT<AgentSimItemSlot>.DistBtwWorldStateViewsT distPrev, 
            WorldStateViewT<AgentSimItemSlot>.DistBtwWorldStateViewsT distNow, 
            WorldStateViewT<AgentSimItemSlot>.DistChgBtwWorldStateViewsT distDelta)? joy3;
        (WorldStateViewT<AgentSimItemSlot>.DistBtwWorldStateViewsT distPrev, 
            WorldStateViewT<AgentSimItemSlot>.DistBtwWorldStateViewsT distNow, 
            WorldStateViewT<AgentSimItemSlot>.DistChgBtwWorldStateViewsT distDelta)? joy4;
        ...
        if (joy1 != null)  // if passes all the threshold conditions
        {
            ...
            joyIntensity1Prime = joyIntensity.UpdateWithChg(intensityDelta1); 
        ...
        if (joy2 != null)  // if passes all the threshold conditions
        {
            ...
            // update the value if changed
            joyIntensity2Prime = joyIntensity.UpdateWithChg(intensityDelta2); 
            ...
            // update the value if changed
            joyIntensity3Prime = joyIntensity.UpdateWithChg(intensityDelta3); 
