...
namespace EMgine
{
    internal static class MessageLookup
    {
        private static readonly Dictionary<string, string> messages = new Dictionary<string, string>()
        {
            ...
            // EmStateT
            { "W-EST_NO_CURRENT_INTENSITY", "Warning: No value given for the current intensity of {0} in the emotion state. Setting to minimum emotion intensity." },
            { "W-EST_NO_MAX_INTENSITY", "Warning: No value given for the maximum intensity of {0} in the emotion state. Setting to default emotion intensity maximum." },
            { "W-EST_NO_INTENSITY_CHANGE", "Warning: No value given for the intensity change of {0} in the emotion state. It is assumed that the intensity of {0} did not change." },
            ...
            // GoalT
            { "W-G_IMPORTANCE_IS_NEGATIVE", "Warning: Importance value assigned to the goal is less than zero. Setting it to zero." },
